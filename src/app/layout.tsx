...
import { Geist, Bytesized } from "next/font/google";
import "./globals.css";
...
// Pixel/byte display font for the Tapas wordmark.
...
export default function RootLayout({
  ...
  return (
    <html
      lang="en"
      className={`${geistSans.variable} ${bytesized.variable} h-full antialiased`}
    >
